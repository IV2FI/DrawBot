...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.appBox.setItemText(3, _translate("MainWindow", "Autre"))
    ...
    def displayMouseCoordinatesWorker(self):
        initCoordinate = utils.getNextMouseClickPositionCoordinates()
        self.MouseCoordinateLabel.setText(str(initCoordinate))
        if(self.app == 0):
            self.registerColorPosInGarticFolder(initCoordinate)
        elif(self.app == 1):
            self.registerColorPosInFolderSkribbl(initCoordinate)
        elif(self.app == 2):
            self.registerColorPosINFolderPaint(initCoordinate)


    def initFichierCoordinate(self, coordinate, app):
        coordinatesFile = os.path.dirname(os.path.abspath(__file__)) + "\\colorPalettes\\" + app + "Coordinates.txt"
        os.remove(coordinatesFile)
        for coo in coordinate:
            open(coordinatesFile, 'a').write(coo)

    def registerColorPosInGarticFolder(self, firstCoordinates):
